...
enum D2CStat
{
	...
	//D2Common::D2GetUnitStat(pUnit, 17, 0),//非武器ED
	//D2Common::D2GetUnitStat(pUnit, 18, 0),//非武器ED
	//D2Common::D2GetUnitStat(pUnit, 21, 0),//武器（计算过ed）
	//D2Common::D2GetUnitStat(pUnit, 22, 0),//武器（计算过ed）
	//D2Common::D2GetUnitStat(pUnit, 23, 0),//除了武器之外其他地方加的最小
	//D2Common::D2GetUnitStat(pUnit, 24, 0),//除了武器之外其他地方加的最大
	//D2Common::D2GetUnitStat(pUnit, 25, 0)//技能等ED加成


    STATS_ITEM_MAXDAMAGE_PERCENT,//17
    STATS_ITEM_MINDAMAGE_PERCENT,//18
    STATS_TOHIT,
    STATS_TOBLOCK,
    STATS_MINDAMAGE,
    STATS_MAXDAMAGE,
